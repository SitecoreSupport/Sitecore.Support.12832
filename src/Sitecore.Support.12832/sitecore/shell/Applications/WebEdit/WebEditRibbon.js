...
function scAdjustSize() {
    ...
    iframeWin = frame.contentWindow || frame.contentDocument.parentWindow;
    ...
    if (crossPiece) {
        ...
        crossPiece.style["max-height"] = "102px";
    }
